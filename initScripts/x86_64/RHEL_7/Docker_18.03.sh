...
# initScript for RHEL_7 and Docker 18.03
# ------------------------------------------------------------------------------
...
install_docker_prereqs() {
  ...
  if [[ $(rpm -q container-selinux) != "container-selinux-2.42-1.gitad8f0f7.el7.noarch" ]]; then
    install_container_selinux='sudo yum install -y http://mirror.centos.org/centos/7/extras/x86_64/Packages/container-selinux-2.74-1.el7.noarch.rpm'
